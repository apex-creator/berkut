...
function getRmDefaultStart(moduleInstance, resType) {
    ...
    let instConfig = getInstanceConfig(moduleInstance);
    if (selfCoreName === "m4fss0-0") {
        defOwnDmaChStart = instConfig.defaultOwnDmaChannelStart_m4fss0_0;
        defOwnQdmaChStart = instConfig.defaultOwnQdmaChannelStart_m4fss0_0;
        defOwnTccStart = instConfig.defaultOwnTccStart_m4fss0_0;
        defOwnParamStart = instConfig.defaultOwnParamStart_m4fss0_0;
        defReservedDmaChStart = instConfig.defaultReservedDmaChannelStart_m4fss0_0;
    }
    if(resType == "ownDmaCh") {
...
function getRmDefaultEnd(moduleInstance, resType) {
    ...
    let instConfig = getInstanceConfig(moduleInstance);
    if (selfCoreName === "m4fss0-0") {
        defOwnDmaChEnd = instConfig.defaultOwnDmaChannelEnd_m4fss0_0;
        defOwnQdmaChEnd = instConfig.defaultOwnQdmaChannelEnd_m4fss0_0;
        defOwnTccEnd = instConfig.defaultOwnTccEnd_m4fss0_0;
        defOwnParamEnd = instConfig.defaultOwnParamEnd_m4fss0_0;
        defReservedDmaChEnd = instConfig.defaultReservedDmaChannelEnd_m4fss0_0;
    }
    if(resType == "ownDmaCh") {
