...
function pinmuxRequirements(instance) {
    ...
    pinResource = pinmux.getPinRequirements(interfaceName, "SYNCO", "EPWM_SYNCO")
    pinmux.setConfigurableDefault( pinResource, "rx", false );
    resources.push( pinResource);

    pinResource = pinmux.getPinRequirements(interfaceName, "SYNCI", "EPWM_SYNCI");
...
function getPeripheralPinNames(instance) {
    return [ "0", "1", "EPWM_SYNCO", "EPWM_SYNCI" ];
}
