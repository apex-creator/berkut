...
SECTIONS
{
    ...
    .bss:    {} palign(8) > M4F_SHRM     /* This is where uninitialized globals go */
    RUN_START(__BSS_START)
    RUN_END(__BSS_END)
    .text:   {} align(8) >> M4F_SHRM     /* This is where code resides */
    .data:   {} align(8) >> M4F_SHRM         /* This is where initialized globals and static go */
    .rodata: {} align(8) >> M4F_SHRM    /* This is where const's go */
...
MEMORY
{
    ...
    M4F_RAM3  : ORIGIN = 0x00460000 , LENGTH = 0x00020000    /*RAM3 */
    M4F_SHRM : ORIGIN = 0x00480000 , LENGTH = 0x00040000   /* 256KB shared RAM in APPSS (Can be combined with RAM3 for contiguous memory) */

    HWASS_SHM_MEM : ORIGIN = 0x60000000, LENGTH = 0x00040000 /* 160KB in HWA PD + 96 KB FECSS Shared RAM */
}
